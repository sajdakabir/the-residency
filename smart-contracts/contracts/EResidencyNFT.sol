 ...
 */
contract EResidencyNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    function mintNFT(
        ...
        require(balanceOf(to) == 0, "Address already has an eResidency NFT");
    ...
    function tokenOfOwner(address owner) external view returns (uint256) {
        require(balanceOf(owner) > 0, "Owner has no tokens");
    ...
    function _update(
        ...
        require(
            ...
            "eResidencyNFT: Token is soulbound and cannot be transferred"
        );
