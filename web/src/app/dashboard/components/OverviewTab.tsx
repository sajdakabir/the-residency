    ...
    <div className="space-y-8">
          ...
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Residency Status</dt>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">e-Residency Since</dt>
                  <dd className="flex items-baseline">
                    <div className="text-2xl font-semibold text-gray-900">
        ...
        <div className="bg-white px-4 py-5 sm:p-6">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <button
              ...
              className="bg-white overflow-hidden shadow rounded-lg border border-gray-200 hover:border-indigo-500 transition-colors duration-150"
            >
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">Apply for Visa</h3>
                    <p className="mt-1 text-sm text-gray-500">Start a new visa application</p>
                  </div>
                </div>
              </div>
            </button>
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
          ...
          <p className="mt-1 text-sm text-gray-500">Your most recent applications and their status</p>
        </div>
        <div className="bg-white px-4 py-5 sm:p-6">
